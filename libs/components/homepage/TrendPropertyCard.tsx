...
const TrendPropertyCard = (props: TrendPropertyCardProps) => {
	const { instrument, likePropertyHandler } = props;
	...
	const renderCard = () => (
		<Stack className="trend-card-box" key={instrument._id}>
			<Box
				component={'div'}
				className={'card-img'}
			...
			<Box component={'div'} className={'info'}>
				...
				<div className={'bott'}>
					...
					<div className="view-like-box">
						...
						<IconButton color={'default'} onClick={() => likePropertyHandler(user, instrument?._id)}>
